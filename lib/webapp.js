...
module.exports = function(w) {
  ...
  createSearch.onclick = (function() {
    ...
    ImmoSearch.start(suche, this.newMatches.bind(this, searchtitle));
  }).bind(this);
  this.window.document.body.appendChild(createSearch);
};

module.exports.prototype.newMatches = function(title) {
  var results = this.searchresults.search[title];
  this.window.alert("found " + results.length + " matches for " + title);
};
